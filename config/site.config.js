...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'me@afdulfauzan.my.id',
  ...
  protectedRoutes: ['/rom/derp'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:me@afdulfauzan.my.id',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/afdulfauzan',
    },
  ],
